...
class RotateAgentMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        # Firefox – macOS
        "Mozilla/5.0 (Macintosh; Intel Mac OS X 13.3; rv:121.0) Gecko/20100101 Firefox/121.0",
...
class WheelsamericaSpiderMiddleware:
...
class WheelsamericaDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
